...
<div class="category-index">
    ...
    <div class="controls">
        <div class="form-group stretch">
            <label for="search" >Search Category By Name</label>
            <input type="text" id="search" name="search" placeholder="search category by name" class="text-field" onkeyup="search()">
        </div>
        ...
        <div class="form-group">
            <a href="{{ route('categories.create') }}" class="button shadow click-shadow success">Create</a>
        </div>
        @endcan
...
@push("JS")
    ...
    @if (Session::has('category_deleted'))
        <script>
            toastr.success("{!! Session::pull('category_deleted') !!}");
        </script>
    @endif
@endpush
