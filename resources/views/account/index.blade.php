...
<div class="account-index">
    ...
    <div class="controls">
        <div class="form-group stretch">
            <label for="search" >Search Account By Name</label>
            <input type="text" id="search" name="search" placeholder="search account by name" class="text-field" onkeyup="search()">
        </div>
        ...
        @can('Accounts Create')            
        <div class="form-group">
            <a href="{{ route('accounts.create') }}" class="button shadow click-shadow success">Create</a>
        </div>
        @endcan
...
@push("JS")
    ...
    @if (Session::has('account_deleted'))
        <script>
            toastr.success("{!! Session::pull('account_deleted') !!}");
        </script>
    @endif
@endpush
