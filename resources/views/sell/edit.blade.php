...
<div class="sell-edit">
    <form action="{{ route('sells.update',$sell->id) }}" method="POST" id="sell_edit_form">
            ...
            <table class="table">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td class="right"><input type="number" class="text-field right" value="{{ empty($sell->discount) ? 0 : $sell->discount }}" id="sell_discount" min="0"></td>
                    </tr>
        ...
        <div class="button-container">
            ...
            <div>
                <button class="button shadow click-shadow primary" type="submit" id="sell_update">Update</button>
